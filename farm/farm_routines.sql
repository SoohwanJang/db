...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `subcategoryview` AS select 1 AS `id`,1 AS `name`,1 AS `sup`,1 AS `pName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `suboriginview` AS select 1 AS `id`,1 AS `pName`,1 AS `name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `sellerproductview` AS select 1 AS `id`,1 AS `sellerId`,1 AS `categoryId`,1 AS `originId`,1 AS `name`,1 AS `regName`,1 AS `detail`,1 AS `price`,1 AS `regDate`,1 AS `startDate`,1 AS `endDate`,1 AS `leadTime`,1 AS `image`,1 AS `tag`,1 AS `pub`,1 AS `isDel`,1 AS `firstcatg`,1 AS `secondcatg`,1 AS `firstorigin`,1 AS `secondorigin`,1 AS `qty`,1 AS `uid` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `basketview` AS select 1 AS `id`,1 AS `itemId`,1 AS `memberId`,1 AS `qty`,1 AS `regDate`,1 AS `itemName`,1 AS `itemDetail`,1 AS `price`,1 AS `leadTime`,1 AS `image`,1 AS `endDate`,1 AS `deliveryFee` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `favitemview` AS select 1 AS `id`,1 AS `itemId`,1 AS `memberId`,1 AS `regDate`,1 AS `itemName`,1 AS `itemImgName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `categoryview` AS select 1 AS `id`,1 AS `pName`,1 AS `name`,1 AS `sup` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-09-17  9:49:48
